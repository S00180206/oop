...
namespace LabSheet3Q5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Total money from all cash register: {0}",CashRegister.totalMoneyAllCRs);
            Console.WriteLine("Total items from all cash register: {0}", CashRegister.totalItemsAllCRs);
        }
    }
}
